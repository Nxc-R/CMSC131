...
public class TestingSupport {
	...
	public static boolean writeToFile(String filename, String message) {
		try {
			...
			output.close();
			System.out.println(filename + " has test results (Refresh Eclipse Folder to see");
	...
	/**
	 * Writes results of test to a file with the suffix "Results.txt"
	 * 
	 * @param filename
	 * @param message
	 * @return
	 */
	public static boolean writeToFileTestResults(String testName, String message) {
		String filename = testName + "Results.txt";
		try {
			FileWriter output = new FileWriter(filename);
			output.write(message);
			output.close();
			System.out.println("The file " + filename + " has test's results (Refresh Eclipse Folder to see file)");
